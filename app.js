...
// =========================
  ...
  function findFilterPanel() {
    ...
    while (cur && cur !== document.body && cur !== document.documentElement) {
      if (containsAll(cur)) best = cur; // keep walking up to find the smallest that still contains all
      cur = cur.parentElement;
    }
    return best || apply.closest("section, aside, .sidebar, .filters, .filter-panel, .panel") || apply.parentElement;
  }
